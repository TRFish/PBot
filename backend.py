...
def news():
	...
	print('По заголовку вы могли понять, что я ничего не добавил, но _|__|_ \|Ничего|/ _|__|_ это новая команда, которая выводит _|__|_ \|НИЧЕГО|/ _|__|_ !')
	print('И самое важное в этой команде она в добавок ко всему ничего не делает!')
	print('- Команда нового функционала (/new)')
	print('Выводит честные причины долгого выхода обговлений.')
	print('Если она не работает то можете мне об этом не писать. (Если честно я вообще хз работает ли юникод в Алгоритмике)')
	print('- Echo-mode (/echo)')
	print('Просто выводит то, что ты пишешь')
	print('Осторожно! Выйти от туда немного затруднительно.')
